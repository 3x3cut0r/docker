...
$config = [
    ...
    'auth.adminpassword' => '{ADMIN_PASSWORD_HASH_ALG}{ADMIN_PASSWORD_HASH}',
 ...
 // 'session.cookie.samesite' => \SimpleSAML\Utils\HTTP::canSetSameSiteNone() ? 'None' : 'Lax',
    ...
    'language.cookie.secure' => {SIMPLESAML_SESSION_COOKIE_SECURE},
    'language.cookie.httponly' => false,
    'language.cookie.lifetime' => (60 * 60 * 24 * 900),
 // 'language.cookie.samesite' => \SimpleSAML\Utils\HTTP::canSetSameSiteNone() ? 'None' : 'Lax',
    'language.cookie.samesite' => '{SIMPLESAML_SESSION_COOKIE_SAMESITE}',
