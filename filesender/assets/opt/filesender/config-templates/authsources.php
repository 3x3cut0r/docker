...
$config = [
    ...
    'dsn' => 'mysql:host=mariadb-gen-primary.db;dbname=fs_demo',
    'username' => 'fs_demo',
    'password' => 'heelgeheim',
    ...
    */
    'demo-hash' => [
        'authcrypt:Hash',
	'admin:$2y$10$tK19vC5gf8yQm/.sYFE4PeE6/QT.M39o6SsyuUUppRvakNz7Ou0.W' => [
		'uid' => ['admin'],
		'eduPersonAffiliation' => ['member', 'employee', 'it'],
		'email' => ['admin@secret.dom'],
	],
	'nils:$2y$10$LCLwBTgJvFNDikgMYPLOse2PKAmc/rOA4rw2UBIHXHwkyNr21XRWy' => [
		'uid' => ['nils'],
		'eduPersonAffiliation' => ['member', 'employee'],
		'email' => ['nils@secret.com'],
	],
    ],
